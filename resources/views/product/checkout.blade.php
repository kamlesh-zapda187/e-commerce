        ...
        <div class="row"> 
            <div class="col-lg-8 col-12">
                <div class="checkout-form">
                    ...
                    <form role="form" method="post" class="form require-validation lgy__billing_form" data-cc-on-file="false" data-stripe-publishable-key="{{$stripe_publish_key}}" id="payment-form">


                        <input type="hidden" name="user_type" value="{{ (Auth::check()) ? 'register_user' : 'guest_user' }}" />
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>First Name<span>*</span></label>
                                    
                                    <input type="text" name="first_name" placeholder="" required="required" value="Kamlesh">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" placeholder="" required="required" value="ZApda">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="contact" placeholder="" required="required" value="7894561230">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address2" placeholder="" required="required" value="bhanvad">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Postal Code<span>*</span></label>
                                    <input type="text" name="zipcode" placeholder="" required="required" value="360501">
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div id="lgy__sp_payment_form" style="padding: 10px 30px;margin-top: 10px;">
                        </div>
                        <!--/ End Button Widget -->
                    </div>
